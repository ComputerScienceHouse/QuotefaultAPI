...
SERVER_NAME = os.environ.get('API_QUOTEFAULT_SERVER_NAME', 'api.quotefault.csh.rit.edu')
...
OIDC_CLIENT_CONFIG = {
    ...
    'post_logout_redirect_uris': [os.environ.get('API_QUOTEFAULT_OIDC_LOGOUT_REDIRECT_URI', 'https://api.quotefault.csh.rit.edu/logout')]
}